...
const techStack = [
  ...
  { id: 4, icon: <FaReact size={iconSize} color="#61DAFB" />, name: "React" },
  { id: 5, icon: <FaGitAlt size={iconSize} color="#F05032" />, name: "Git" },
  { id: 6, icon: <FaGithub size={iconSize} color="#181717" />, name: "GitHub" },
  { id: 7, icon: <FaPython size={iconSize} color="#3776AB" />, name: "Python" },
];

const Skills = () => {
  return (
    <section id="skills" classNameName=' py-4 px-8'>
      <div className="text-white rounded-2xl px-6 pt-6 md:px-8 max-w-6xl mx-auto">
